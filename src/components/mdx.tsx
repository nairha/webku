...
function createTable({ children }: { children: ReactNode }) {
  return (
    <div style={{ overflowX: "auto", width: "100%", margin: "16px 0", borderRadius: "8px", border: "1px solid var(--neutral-alpha-medium)" }}>
      <table style={{ 
        width: "100%", 
...
function createTableCell(as: "th" | "td") {
  return ({ children }: { children: ReactNode }) => {
    ...
    return (
      <Tag style={{ 
        ...
        background: as === "th" ? "var(--neutral-alpha-weak)" : "transparent",
        color: as === "th" ? "var(--neutral-on-background-strong)" : "var(--neutral-on-background-medium)",
      }}>
        {children}
      </Tag>
    );
  ...
  return (
    <MDXRemote
      ...
      components={{ 
        ...
        th: createTableCell("th") as any,
        td: createTableCell("td") as any,
        ...(props.components || {}) 
      }}
    />
  );
